...
void scalar_mult_generic(scalar *out, const scalar *lhs, const scalar *rhs);
void scalar_mult_add_generic(scalar *out, const scalar *lhs, const scalar *rhs);
void inner_product_generic(scalar *out, const scalar *lhs, const scalar *rhs, int rank);
void matrix_mult_intt_generic(scalar *out, const scalar *m, const scalar *a, int rank);

/* Function pointers for dispatch */
static ml_kem_scalar_mult_fn scalar_mult = scalar_mult_generic;
static ml_kem_scalar_mult_add_fn scalar_mult_add = scalar_mult_add_generic;
static ml_kem_inner_product_fn inner_product = inner_product_generic;
 ...
 * */
    ...
    if (S390X_VX_CAPABLE) {
        ...
        scalar_mult = scalar_mult_vec128;
        scalar_mult_add = scalar_mult_add_vec128;
        inner_product = inner_product_vec128;
...
void scalar_mult_generic(scalar *out, const scalar *lhs,
    const scalar *rhs)
{
...
ossl_inline void scalar_mult_add_generic(scalar *out, const scalar *lhs,
    const scalar *rhs)
{
    uint16_t *curr = out->c, *end = curr + DEGREE;
    const uint16_t *lc = lhs->c, *rc = rhs->c;
...
void inner_product_generic(scalar *out, const scalar *lhs, const scalar *rhs,
    int rank)
{
 ...
 */
void
matrix_mult_intt_generic(scalar *out, const scalar *m, const scalar *a, int rank)
{
    const scalar *ar;
    int i, j;
